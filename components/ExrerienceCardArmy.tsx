...
import img2 from "../images/army.png"
import image3 from "../images/oracle.png"
...
const ExrerienceCardArmy = (props: Props) => {
  return (
    <article className='flex flex-col rounded-2xl hover:shadow-lg items-center space-y-7 flex-shrink-0 w-[400px] md:w-[600px] xl:w-[900px] snap-center bg-[#00A2DE] p-10 hover:opacity-100 opacity-50 cursor-pointer transition-opacity duration-200'>
        ...
        whileInView={{
            ...
            <div className='px-0 md:px-10 text-left'>
                <h4 className='text-4xl font-light'>Officer</h4>
                <p className='font-bold text-2xl mt-1'>Egyptian Armed Forces</p> 
        ...
        <ul className='list-disc space-y-4 ml-5'>
            <li> Responsible for information technology officer affair database</li>
            <li>Worked in multimedia production for the military information technology institute </li>
            <li>Joined the system analysis team for six months</li>
...
export default ExrerienceCardArmy